"use strict";
// The data
function peopleInfo(name, yearOfBirth, children, country, knowsHowToProgram) {
    return {
        name,
        yearOfBirth,
        children,
...
if (personTwo.children === personThree.children) {
    ...
    console.log("No, they don't have the same amount of children");
//
